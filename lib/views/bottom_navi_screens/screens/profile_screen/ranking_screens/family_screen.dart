...
class FamilyRankingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const RankingMainScreen(initialPage: 2);
  }
}

class FamilyRankingContent extends StatelessWidget {
  const FamilyRankingContent({super.key});
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        /// Background Image
        Positioned.fill(
          child: Image.asset("assets/images/ranking3.png", fit: BoxFit.cover),
        ),
