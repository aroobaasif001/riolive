                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                CustomContainer(
                                  conColor: Colors.lightBlue.withOpacity(0.4),
                                ...
                                CustomContainer(
                                  conColor: Colors.purple.withOpacity(0.4),
                                  borderRadius: BorderRadius.circular(25),
                                  border: Border.all(
                                    color: Colors.white.withOpacity(0.3),
                                    width: 1,
                                ...
                                CustomContainer(
                                  conColor: Colors.greenAccent.withOpacity(0.4),
                                  borderRadius: BorderRadius.circular(25),
                                  border: Border.all(
                                    color: Colors.white.withOpacity(0.3),
                                    width: 1,
                            ...
                            CustomContainer(
                              ...
                              width: (size.width * 0.7) * 0.0, // progress value
                            ),
                            const SizedBox(height: 8),
                ...
                Positioned(
                  ...
                  child: Row(
                    children: [
                      ...
                      RoundIcon(image: const AssetImage('assets/icons/pk.png')),
                      const SizedBox(width: 14),
                      InkWell(
                        onTap: () => showRoomToolsSheet(context),
                        child: RoundIcon(
                          image: const AssetImage('assets/icons/apps.png'),
                        ),
                      ),
                    ],
                  ),
