          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 25),
                CustomTextFormField(
                  hintText: 'Enter your email or phone nu...',
                  prefix: Image(image: AssetImage('assets/icons/emailicon.png'), height: 22, width: 28),
                ),
                SizedBox(height: 16),
                CustomTextFormField(
                  hintText: 'Enter Password',
                  prefix: Image(image: AssetImage('assets/icons/passwordicon.png'), height: 22, width: 28),
                ),
                SizedBox(height: 110),
                CustomButton(height: 57, width: 386, text: 'Next', onPressed: () {}),
                SizedBox(height: 16),
